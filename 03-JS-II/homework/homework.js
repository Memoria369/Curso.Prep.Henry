...
function fizzBuzz(numero) {
  ...
  if (numero / 3 === 3){return 'fizz'}
  if (numero / 5 === 2){return 'buzz'}  
  if ((numero / 3 === 5) && (numero / 5 === 3)) {return 'fizzbuzz'}   
  else{return numero;} 
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
tabla6 = []
tabla6.push(0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 60);
return tabla6;
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (Number(numero.toString().length === 3)){return true;}  
  else{return false;}
}
